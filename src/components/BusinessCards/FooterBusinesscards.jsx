...
const FooterBusinesscards = () => {
  return (
    <>
      <footer>
        <div className="bg-[#151515] bg-cover w-full md:py-20 py-6 px-5">
          <div className="flex justify-start flex-wrap xl:flex-nowrap md:py-0 py-16 space-y-8 items-center px-2">
            <div className="text-start w-full max-w-[320px] space-y-3">
              {/* <img src={footerlogo} alt="" /> */}
              <h1 className="font-medium text-[18px] text-[#F8F8F8] cursor-pointer transition-colors hover:text-[#1A7E91]">
                You need it. We print it. You love it.
              </h1>
              <p className="text-[14px] text-[#F8F8F8] pb-5">
                Codex Prints is <span className="underline">here to help</span>{" "}
...
export default FooterBusinesscards;
